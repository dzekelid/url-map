...
apis:
- name: Compute Engine - Get URL Maps
  x-api-slug: projectglobalurlmaps-get
...
- name: Compute Engine - Delete URL Map
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/url-map/master/_listings/google-compute-engine/projectglobalurlmapsurlmap-delete-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/url-map/master/_listings/google-compute-engine/projectglobalurlmapsurlmap-delete-openapi.md
- name: Compute Engine - Get URL Map
  x-api-slug: projectglobalurlmapsurlmap-get
